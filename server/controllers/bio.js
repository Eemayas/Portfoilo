...
export const createBioCard = async (req, res) => {
  ...
  try {
    ...
    res.status(404).json({ message: `createBioCard Error:\n${error.message}` });
  }
};
...
export const editBioCard = async (req, res) => {
  try {
    ...
    res.status(404).json({ message: `editBioCard Error:\n ${error.message}` });
  }
};
...
export const deleteBioCard = async (req, res) => {
  ...
  res.status(200).json({ message: "Post deleted successfully." });
    ...
    res.status(404).json({ message: `deleteBioCard Error:\n ${error.message}` });
...
export const createBioSkill = async (req, res) => {
  ...
  try {
    ...
    res.status(404).json({ message: `createbioSkill Error:\n${error.message}` });
  }
};
...
export const editBioSkill = async (req, res) => {
  try {
    ...
    res.status(404).json({ message: `editbioSkill Error:\n ${error.message}` });
  }
};
...
export const deleteBioSkill = async (req, res) => {
  ...
  res.status(200).json({ message: "Post deleted successfully." });
    ...
    res.status(404).json({ message: `deletebioSkill Error:\n ${error.message}` });
