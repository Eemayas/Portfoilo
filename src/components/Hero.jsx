...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      <div
        className={`absolute bg-white bg-opacity-20 backdrop-blur-lg rounded-[50px] drop-shadow-lg w-full h-fit md:min-h-[80%] top-[5%] max-w-7xl mx-auto flex flex-col-reverse md:flex-row  p-6 md:p-20  gap-5 items-center `}
      >
...
const ProfileAvatars = () => {
  return (
    <div className="w-full h-60  flex justify-center items-center md:h-80 md:w-80">
      ...
      <img
          src={ProfilePic2}
          className="shadow-slate-500 shadow-md aspect-w-16 aspect-h-9 w-auto h-auto rounded-2xl bg-center bg-cover duration-500 object-cover"
        />
        {/* <Avatar
